<?php
 ...
 $id_gallery = mysqli_fetch_assoc($query);
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-7 col-lg-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="editfotopro.php" method="POST">
                            <div class="form-group row">
                                <div class="col">
                                    <input name="id_gallery" type="hidden" class="form-control" id="id_gallery" 
                                    value="<?php echo $id_gallery['id_gallery']?>">
                                </div>
                            </div>
                            <div class="form-group mb-3">
                                <label for="foto"><h5>Foto</h5></label>
                                <div class="col">
                                    <input name="foto" type="url" class="form-control" id="foto"
                                    value="<?php echo $id_gallery['foto']?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="col">
                                    ...
                                    value="<?php echo $id_gallery['keterangan']?>">
                                </div>
                            </div>
